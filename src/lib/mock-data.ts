...
const generateProducts = (): Product[] => {
  ...
  products.push({
    ...
    condition: 'NEW',
    conditionDetails: 'Never worn (plastic on hardware) - The open pocket on the front wall has two faint scuff marks',
    specialNotes: 'Extremely rare HSS (Horseshoe Stamp) Special Order configuration.'
  });
...
export const AFFILIATES: Affiliate[] = [
  { id: 'aff-1', name: 'Elena Vance', tier: 'Diamond', referralCode: 'ELENA1924', salesGenerated: 125000, commissionEarned: 12500, status: 'active', brandId: 'amarise-luxe' },
  { id: 'aff-2', name: 'Marcus Aurelius', tier: 'Gold', referralCode: 'MARCUS', salesGenerated: 45000, commissionEarned: 4500, status: 'active', brandId: 'amarise-luxe' }
];
...
export const VENDORS: Vendor[] = [
  { id: 'vend-1', name: 'Lumière Silks', category: 'Accessories', performance: 98, productCount: 45, salesTotal: 125000, status: 'active', payoutSchedule: 'weekly', joinedDate: '2023-01-10', kpis: { returnRate: 1.2, fulfillmentSpeed: '1.2 days', rating: 4.9 }, brandId: 'amarise-luxe' },
  { id: 'vend-2', name: 'Geneva Horology', category: 'Watches', performance: 95, productCount: 12, salesTotal: 850000, status: 'active', payoutSchedule: 'monthly', joinedDate: '2023-05-15', kpis: { returnRate: 0.5, fulfillmentSpeed: '2.4 days', rating: 4.8 }, brandId: 'amarise-luxe' },
  { id: 'vend-3', name: 'Artisanal Gold', category: 'Jewelry', performance: 92, productCount: 28, salesTotal: 340000, status: 'active', payoutSchedule: 'weekly', joinedDate: '2023-08-20', kpis: { returnRate: 2.1, fulfillmentSpeed: '1.8 days', rating: 4.7 }, brandId: 'amarise-luxe' }
];

export const CAMPAIGNS: Campaign[] = [
  { id: 'camp-1', title: 'Midnight Soirée Flash Sale', type: 'Flash Sale', status: 'scheduled', discountValue: 15, startDate: '2024-04-01', endDate: '2024-04-03', market: 'global', reach: 45000, conversions: 1200, roi: 4.5, predictedRoi: 5.2, abTestActive: true, brandId: 'amarise-luxe' },
  { id: 'camp-2', title: 'Heritage Collection Launch', type: 'Launch', status: 'active', discountValue: 0, startDate: '2024-03-10', endDate: '2024-03-25', market: 'us', reach: 120000, conversions: 800, roi: 8.2, predictedRoi: 9.0, abTestActive: false, brandId: 'amarise-luxe' },
  { id: 'camp-3', title: 'Spring Equinox Newsletter', type: 'Email', status: 'completed', discountValue: 10, startDate: '2024-03-01', endDate: '2024-03-05', market: 'global', reach: 250000, conversions: 4500, roi: 12.4, predictedRoi: 11.5, abTestActive: true, brandId: 'amarise-luxe' }
];

export const CUSTOMER_SEGMENTS: CustomerSegment[] = [
  { id: 'seg-1', name: 'Ultra-High Net Worth', description: 'Clients with >$100k lifetime spend.', userCount: 450, avgOrderValue: 12500, tags: ['Diamond', 'Bespoke'], predictedChurn: 0.05, brandId: 'amarise-luxe' },
  { id: 'seg-2', name: 'Seasonal Enthusiasts', description: 'Purchased in last 3 months.', userCount: 2800, avgOrderValue: 3200, tags: ['Active', 'Fashion'], predictedChurn: 0.15, brandId: 'amarise-luxe' },
  { id: 'seg-3', name: 'Dormant Connoisseurs', description: 'No purchase in 12 months.', userCount: 1200, avgOrderValue: 4500, tags: ['Inactive', 'Luxury'], predictedChurn: 0.45, brandId: 'amarise-luxe' }
];

export const APPOINTMENTS: Appointment[] = [
  { id: 'apt-1', customerId: 'vip-1', customerName: 'Julian Vandervilt', type: 'Private Viewing', date: '2024-03-20', time: '14:00', city: 'London', status: 'confirmed', brandId: 'amarise-luxe' },
  { id: 'apt-2', customerId: 'vip-2', customerName: 'Sophia Chen', type: 'Virtual Try-on', date: '2024-03-22', time: '10:30', city: 'Dubai', status: 'pending', brandId: 'amarise-luxe' }
];

export const INVOICES: Invoice[] = [
  { id: 'inv-1001', orderId: 'AM-1001', customerName: 'Julian Vandervilt', amount: 45000, currency: 'USD', status: 'paid', date: '2024-03-10', taxAmount: 3600, taxRate: 8, complianceCertified: true, brandId: 'amarise-luxe' },
  { id: 'inv-1002', orderId: 'AM-1002', customerName: 'Sophia Chen', amount: 12500, currency: 'GBP', status: 'issued', date: '2024-03-14', taxAmount: 2500, taxRate: 20, complianceCertified: true, brandId: 'amarise-luxe' }
];
