...
const HERMES_SIDEBAR = [
  {
    ...
    items: [
      ...
      { id: "hss", label: "Horseshoe Stamp (HSS) Bags" },
      {
        id: "evelyne",
        label: "Evelyne Bags",
        subItems: [{ label: "Mini Evelyne (TPM) Bags", id: "mini-evelyne" }],
      },
    ],
  },
];
  ...
  const birkinProducts = [
    {
      ...
      price: 31741.89,
      imageUrl:
        "https://picsum.photos/seed/hermes-birkin-white-etoupe/1000/1200",
    },
    {
      id: "prod-10",
      ...
      price: 33481.17,
      imageUrl:
        "https://picsum.photos/seed/hermes-birkin-rose-sakura/1000/1200",
    },
    {
      id: "prod-50",
      ...
      price: 27393.69,
      imageUrl:
        "https://picsum.photos/seed/hermes-birkin-white-swift/1000/1200",
      isNew: true,
    },
  ];
  ...
  return (
    <div className="bg-white min-h-screen pb-20 animate-fade-in font-body">
      ...
      <Sheet open={isFilterOpen} onOpenChange={setIsFilterOpen}>
        <SheetContent
          side="right"
          className="w-full sm:max-w-[450px] p-0 border-none rounded-none bg-white flex flex-col h-full shadow-2xl"
        >
          ...
          <div className="flex-1 overflow-y-auto px-8 py-4 custom-scrollbar">
            <Accordion
              type="multiple"
              defaultValue={["COLOR", "CONDITION", "PRICE"]}
              className="w-full"
            >
              <AccordionItem
                value="COLOR"
          ...
          <div className="p-8 border-t border-gray-100 bg-white grid grid-cols-2 gap-4">
            <Button
              variant="outline"
              className="h-14 rounded-none border-gray-900 text-[10px] font-bold tracking-[0.3em] uppercase"
            >
              CLEAR ALL
            </Button>
            <Button className="h-14 rounded-none bg-black text-white text-[10px] font-bold tracking-[0.3em] uppercase">
              VIEW (524)
            </Button>
          </div>
        </SheetContent>
          ...
          <aside className="lg:w-72 shrink-0">
            <div className="space-y-10">
              <div className="space-y-2 pb-4 border-b border-gray-100">
                <h2 className="text-2xl font-headline font-medium text-gray-900">
                  {categoryName}
                </h2>
              </div>
              ...
              <div className="flex items-center justify-between py-4 bg-[#f8f8f8] px-8">
                ...
                <div className="flex items-center space-x-12">
                  <button
                    ...
                    className="flex items-center space-x-3 text-[11px] font-bold tracking-[0.2em] text-black hover:opacity-60 transition-all"
                  >
        ...
        <div className="space-y-3 pl-6 mt-2 mb-4 border-none animate-fade-in">
          {item.subItems.map((sub: any) => (
            <Link
              key={sub.id}
              href="#"
              className="block text-[12px] font-light text-gray-500 hover:text-black transition-colors tracking-wide"
            >
              {sub.label}
            </Link>
          ))}
