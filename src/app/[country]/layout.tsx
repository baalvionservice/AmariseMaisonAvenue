          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-20 items-start">
            ...
            <div className="space-y-8">
              ...
              <ul className="space-y-4 text-[13px] font-light text-gray-600">
                ...
                <li><Link href={`/${countryCode}/customer-service`} className="hover:text-black transition-colors">Returns & Shipping</Link></li>
              </ul>
            </div>
            ...
            <div className="space-y-8">
              ...
              <ul className="space-y-4 text-[13px] font-light text-gray-600">
                <li><Link href={`/${countryCode}/about`} className="hover:text-black transition-colors">Our Heritage</Link></li>
                <li><Link href={`/${countryCode}/journal`} className="hover:text-black transition-colors">The Journal</Link></li>
              </ul>
            </div>
