    ...
    <div className="flex h-screen bg-ivory overflow-hidden font-body text-gray-900">
      <aside className="w-72 border-r border-border bg-white p-8 flex flex-col space-y-12 shadow-sm z-20">
        <div className="space-y-4">
          ...
          <p className="text-[9px] text-gray-400 uppercase tracking-widest font-bold">Alerts Terminal</p>
        </div>
        
        <nav className="flex-1 space-y-1 overflow-y-auto pr-2 custom-scrollbar">
          <AdminNavItem icon={<LayoutDashboard />} label="Dashboard" href="/admin" />
          <AdminNavItem icon={<Bell />} label="Institutional Alerts" href="/admin/notifications" active />
      ...
      <main className="flex-1 overflow-y-auto bg-ivory relative">
        <header className="flex justify-between items-center bg-white/80 luxury-blur p-8 border-b border-border sticky top-0 z-30">
          <div>
            <h1 className="text-3xl font-headline font-bold italic text-gray-900 uppercase tracking-widest">Communication Registry</h1>
          ...
          <div className="flex items-center space-x-4">
             <Button variant="outline" className="rounded-none border-border text-[9px] font-bold uppercase tracking-widest h-10 px-6">
              ...
              <Card className="bg-white border-border shadow-luxury overflow-hidden">
                <CardHeader className="border-b border-border bg-ivory/10">
                  <div className="flex justify-between items-center">
                    <CardTitle className="font-headline text-2xl">Maison Feed</CardTitle>
                    <div className="flex items-center space-x-4">
                       <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Showing {scopedNotifications.length} entries</span>
                    </div>
                  </div>
                </CardHeader>
            ...
            <aside className="lg:col-span-4 space-y-8">
              <Card className="bg-black text-white p-8 space-y-6 shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-6">
                  <div className="flex items-center space-x-3 text-secondary">
                    ...
                    <h4 className="text-[10px] font-bold uppercase tracking-widest">Email Scoping</h4>
                  </div>
                  <p className="text-xs font-light italic leading-relaxed opacity-70">
                    "Institutional email alerts are dispatched for high-priority Tier 1 leads and AI system volatility only."
                  </p>
                  <Button variant="outline" className="w-full rounded-none border-secondary text-secondary h-12 text-[9px] font-bold uppercase tracking-widest hover:bg-secondary hover:text-black">
              ...
              <Card className="bg-white border-border p-8 space-y-6 shadow-sm">
                <div className="flex items-center space-x-3 text-plum">
                  ...
                  <h4 className="text-[10px] font-bold uppercase tracking-widest">Automation Logs</h4>
                </div>
                <div className="space-y-4">
